...
class FaceBoxes(nn.Module):
  ...
  def __init__(self, phase, num_classes):
    ...
    self.conv1 = CRelu(3, 24, kernel_size=3, stride=2, padding=3)
    self.conv2 = CRelu(48, 64, kernel_size=3, stride=2, padding=2)
    self.inception = Inception()
    self.conv3 = BasicConv2d(128, 256, kernel_size=3, stride=2, padding=1)
    self.conv4 = BasicConv2d(256, 256, kernel_size=3, stride=2, padding=1)
